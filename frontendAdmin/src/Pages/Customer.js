...
export default class Customer extends React.Component {
    ...
    searching = event => {
        if(event.keyCode === 13){
            ...
            let tempCustomer = this.state.customers
            let result = tempCustomer.filter(item => {
    ...
    componentDidMount = () => {//dijalankan setelah constructor untuk menjalankan get admin karena fungsi tersebut tak ada aksi seperti button
        this.getCustomer()
    }
                        ...
                        <Form onSubmit={e => this.handleSave(e)}>
                            <Modal.Body>
                                <Form.Group className="mb-3 text-dark bg-transparent" controlId="name">
                                    <Form.Label className="text-black" >Customer Name </Form.Label>
                                ...
                                <Form.Group className="mb-3" controlId="password">
                                    ...
                                    <Form.Control className="text-dark bg-transparent" type="password" name="password" placeholder="Masukkan Password" value={this.state.password} onChange={this.handleChange} required/> 
                                </Form.Group>
                            </Modal.Body>
                            <Modal.Footer>
